    ...
    return (
        ...
        <div className='py-4 bg-[#2eab27] border-t-2 border-white-500'>
            <div className='xl:max-w-[1140px] lg:max-w-[90%] md:max-w-[90%] sm:max-w-[90%] w-[95%] mx-auto'>
                <div className='py-12'>
                    <p className='text-white font-bold text-4xl for_font_family'>Full Details About <span className='text-[#e8d500]'>{data.productServiceName}</span></p>
        ...
        <div className='xl:max-w-[1140px] lg:max-w-[90%] md:max-w-[90%] sm:max-w-[90%] w-[95%] mx-auto my-8'>
            <div className='py-8 for_shadow_css mb-4 p-4 rounded-lg'>
                <p className='font-bold text-4xl for_font_family'>Full Details About A Product/Service</p>
